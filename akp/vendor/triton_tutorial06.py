...
@triton.autotune(configs=list(filter(keep, configs)), key=["N_CTX", "HEAD_DIM", "FP8_OUTPUT", "BF16", "warp_specialize"],
...
def _attn_fwd(sm_scale, M,  #
    ...
    dtype = tl.float8e5 if FP8_OUTPUT else (tl.bfloat16 if BF16 else tl.float16)
